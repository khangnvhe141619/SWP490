...
// const buttonTransfer = document.getElementById('btnTransfer')
// buttonTransfer.addEventListener("click", transferToken)
connectMetamask();
let output = [];
...
async function transferToken() {
    ...
    await tokenContract.transfer(addressTo.value,ethers.utils.parseUnits(amount.value))
}
