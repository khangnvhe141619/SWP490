...
INSERT INTO `room` VALUES (1,1,1,'VinFast Lux A 2.0','10:00:00','2022-11-19 00:00:00','2022-11-19 00:00:00',1,'2022-11-19','10:00:00','10:30:00',10,50,'assets/img/Vinfast/e1.jpg'),(2,2,2,'Mercedes-Benz E 300 AMG','10:00:00','2022-11-19 00:00:00','2022-11-19 00:00:00',1,'2022-11-19','10:00:00','10:30:00',10,50,'assets/img/Mer/m1.jpg'),(3,3,2,'BMW 320i Sport Line Plus ','10:00:00','2022-11-19 00:00:00','2022-11-19 00:00:00',1,'2022-11-19','10:00:00','10:30:00',10,50,'assets/img/bmw/b1.jpg'),(4,4,2,'Toyota Land Cruiser Prado','10:00:00','2022-11-19 00:00:00','2022-11-19 00:00:00',1,'2022-11-19','10:00:00','10:30:00',10,50,'assets/img/camry/c1.jpg'),(5,5,2,'Lexus LX 570','10:00:00','2022-11-19 00:00:00','2022-11-19 00:00:00',1,'2022-11-19','10:00:00','10:30:00',10,50,'assets/img/lexus/l1.jpg'),(6,6,2,'Hyundai Santa Fe','10:00:00','2022-11-19 00:00:00','2022-11-19 00:00:00',1,'2022-11-19','10:00:00','10:30:00',10,50,'assets/img/honda/h1.jpg'),(7,7,2,'Porsche Taycan Turbo S','10:00:00','2022-11-19 00:00:00','2022-11-19 00:00:00',1,'2022-11-19','10:00:00','10:30:00',10,50,'assets/img/porche/p1.png'),(8,8,2,'Ferrari F8 Tributo','10:00:00','2022-11-19 00:00:00','2022-11-19 00:00:00',1,'2022-11-19','10:00:00','10:30:00',10,50,'assets/img/audi/a1.jpg'),(9,9,2,'Lamborghini Huracan LP610-4','10:00:00','2022-11-19 00:00:00','2022-11-19 00:00:00',1,'2022-11-19','10:00:00','10:30:00',10,50,'assets/img/ranger/r1.jpg');
...
--
-- Table structure for table `historyBidPrice`
--

DROP TABLE IF EXISTS `historyBidPrice`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `historyBidPrice` (
  `id` int NOT NULL AUTO_INCREMENT,
   `roomId` int NOT NULL,
  `userId` int NOT NULL,
  `yourBid` double NOT NULL,
  `setTime` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `historyBidPrice_roomid_foreign` (`roomId`),
  KEY `historyBidPrice_userid_foreign` (`userId`),
  CONSTRAINT `historyBidPrice_roomid_foreign` FOREIGN KEY (`roomId`) REFERENCES `room` (`id`),
  CONSTRAINT `historyBidPrice_userid_foreign` FOREIGN KEY (`userId`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `historyBidPrice`
--

LOCK TABLES `historyBidPrice` WRITE;
/*!40000 ALTER TABLE `historyBidPrice` DISABLE KEYS */;
/*!40000 ALTER TABLE `historyBidPrice` ENABLE KEYS */;
UNLOCK TABLES;
